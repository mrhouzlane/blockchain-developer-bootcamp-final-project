...
winnerIs.onclick = async () => {
    ...
    let winnerLL = document.getElementById("winnerS")
    const sswinner = document.getElementById("winner")
    const sswinner = await lotteryContract.methods.winner().call()
    winnerLL.innerHTML = "The winner is : " + winnerss
}
