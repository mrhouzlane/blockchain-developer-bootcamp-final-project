...
const lotteryAddress = "0xbbCA84f33e0BfE04e0f440af3AA563E667B608Bc"
const ABI = [
    {
        "inputs": [],
...
balanceOfLottery.onclick = async () => {
    ...
    balance.innerHTML = "The balance of the Lottery is : " + displayBalance(lotteryAddress)
...
async function displayBalance(Address) {
    let contractBalance = await lotteryContract.methods.getBalance(Address).call();
