...
winnerIs.onclick = async () => {
    ...
    let winner = lotteryContract.methods.pickWinner().send({ from: ethereum.selectedAddress });
...
winnerIs.onclick = async () => {
    ...
    lotteryContract.methods.pickWinner().send({ from: ethereum.selectedAddress });
    let winnerLL = document.getElementById("winner")
    await winnerLL.innerHTML = "The winner is : " + winner
}
