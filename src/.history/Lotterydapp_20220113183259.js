...
const winnerIs = documentElementById("get-winner");
winnerIs.onclick = async () => {

    winner = lotteryContract.methods.pickWinner().send({ from: ethereum.selectedAddress });
    let winner = document.getElementById("winner");
    winner.innerHTML = "The winner is : " + winner
