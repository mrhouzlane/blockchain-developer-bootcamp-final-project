...
const lotteryAddress = "0x61680dcaEF568B0DD03C6eb753d8B3e5269cff73"
const ABI = [
    {
        "inputs": [],
...
winnerIs.onclick = async () => {
    ...
    await lotteryContract.methods.rewardWinner(winnerr, ETHBalance).send({ from: ethereum.selectedAddress });
