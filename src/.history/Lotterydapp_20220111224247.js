...
const lotteryStart = document.getElementById("lottery-start-box");
lotteryStart.onclick = async () => {

    var web3 = new Web3(window.ethereum)

    const lotteryContract = new web3.eth.Contract(ssABI, ssAddress)

    lotteryContract.setProvider(window.ethereum)

    lotteryContract.methods.startLottery()
