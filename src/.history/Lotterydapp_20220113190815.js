...
const lotteryAddress = "0x69528ea2C7838310c19E77a0BDdB476fecAEbBbC"
const ABI = [
    {
        "inputs": [],
...
balanceOfLottery.onclick = async () => {
    ...
    let contractBalance = await lotteryContract.methods.getBalance().call({ from: ethereum.selectedAddress });
...
winnerIs.onclick = async () => {
    ...
    var winnerr = await lotteryContract.methods.pickWinner().call({ from: ethereum.selectedAddress });
    let winnerLL = document.getElementById("winner")
    winnerLL.innerHTML = "The winner is : " + winnerr
}

const rewardWinner = document.getElementById("rewards");
rewardWinner.onclick = async () => {

    var rewards = await lotteryContract.methods.rewardWinner().call({ from: ethereum.selectedAddress });
